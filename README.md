...
```bash
npm install @f1stnpm3/beatae-commodi-autem
````

```js
import ChangeTracker from '@f1stnpm3/beatae-commodi-autem';
...
[here](https://github.com/f1stnpm3/beatae-commodi-autem/blob/master/webpack.config.js#L42).
...
Node.js:
```js
const ChangeTracker = require('@f1stnpm3/beatae-commodi-autem');
```
...
```html
<script src="https://unpkg.com/@f1stnpm3/beatae-commodi-autem@^1/browser.js"></script>
<script>
...
```
import ChangeTracker from '@f1stnpm3/beatae-commodi-autem/src/index.ts';
```
Note however that this method requires a transpiler with TypeScript support
(you may look at our
[webpack config](https://github.com/f1stnpm3/beatae-commodi-autem/blob/master/webpack.config.js#L42)
